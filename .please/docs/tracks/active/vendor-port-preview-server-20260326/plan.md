...
- [ ] T001 [P] Create CLI package scaffold with package.json, tsconfig, and bin entry (file: packages/cli/package.json)
- [ ] T002 [P] Create Nuxt 4 preview server app scaffold with nuxt.config and app.vue (file: packages/cli/preview-server/nuxt.config.ts)

### Phase B: Core Infrastructure

- [ ] T003 Build template discovery utility — recursively scan directory for .vue and .tsx email files with validation (file: packages/cli/src/utils/discovery.ts) (depends on T001)
- [ ] T004 Build Vite-based template bundler — create Vite SSR server for compiling and importing .vue/.tsx templates (file: packages/cli/src/utils/bundling.ts) (depends on T001)
- [ ] T005 Build dependency graph and file watcher — chokidar watching with Babel-based import tracking and recursive dependent resolution (file: packages/cli/src/utils/hot-reloading/dependency-graph.ts) (depends on T001)
- [ ] T006 Build Socket.io hot reload server — attach to HTTP server, broadcast file changes with 150ms debounce (file: packages/cli/src/utils/hot-reloading/setup-hot-reloading.ts) (depends on T005)

### Phase C: CLI Commands

- [ ] T007 Implement dev command — launch Nuxt programmatically with hot reload and template watching (file: packages/cli/src/commands/dev.ts) (depends on T003, T004, T006, T002)
- [ ] T008 Implement build command — pre-compile Nuxt preview server for production (file: packages/cli/src/commands/build.ts) (depends on T007)
- [ ] T009 Implement start command — serve pre-built preview server (file: packages/cli/src/commands/start.ts) (depends on T008)
- [ ] T010 Implement export command — render all templates to static HTML/text files (file: packages/cli/src/commands/export.ts) (depends on T004, T003)
- [ ] T011 Implement resend setup/reset commands — manage Resend API key with encrypted config storage (file: packages/cli/src/commands/resend.ts) (depends on T001)

### Phase D: Preview UI — Layout & Navigation

- [ ] T012 Build Nuxt app shell — root layout with Nuxt UI 4, sidebar toggle, responsive structure (file: packages/cli/preview-server/app/app.vue) (depends on T002)
- [ ] T013 Build sidebar with file tree — directory tree component using template discovery data (file: packages/cli/preview-server/app/components/Sidebar.vue) (depends on T012, T003)

### Phase E: Preview UI — Rendering & Display

- [ ] T014 Build email rendering server route — Vite SSR import + render() for on-demand template rendering (file: packages/cli/preview-server/server/api/render.ts) (depends on T004, T002)
- [ ] T015 Build HTML preview pane — iframe-based email display with dark mode color inversion (file: packages/cli/preview-server/app/components/EmailFrame.vue) (depends on T014)
- [ ] T016 Build code view and plain text tabs — source code display with Shiki highlighting and plain text output (file: packages/cli/preview-server/app/components/CodeView.vue) (depends on T014)
- [ ] T017 Build responsive preview controls — width/height presets, mobile/desktop modes, resizable wrapper (file: packages/cli/preview-server/app/components/PreviewControls.vue) (depends on T015)
- [ ] T018 Build error overlay — compilation/render error display with source file mapping (file: packages/cli/preview-server/app/components/ErrorOverlay.vue) (depends on T014)

### Phase F: Preview UI — Hot Reload Integration

- [ ] T019 Build useHotReload composable — Socket.io client connection, reload event listener, template re-rendering (file: packages/cli/preview-server/app/composables/useHotReload.ts) (depends on T006, T014)
- [ ] T020 Build preview page with hot reload integration — catch-all route combining all preview components with live updates (file: packages/cli/preview-server/app/pages/preview/[...slug].vue) (depends on T013, T015, T016, T017, T018, T019)

### Phase G: Toolbar & Validation

- [ ] T021 Build send test email feature — Resend SDK integration in toolbar panel (file: packages/cli/preview-server/app/components/toolbar/SendEmail.vue) (depends on T011, T014)
- [ ] T022 Build email linter — HTML structure validation with issue reporting (file: packages/cli/preview-server/app/components/toolbar/Linter.vue) (depends on T014)
- [ ] T023 Build spam check integration — spam scoring API integration with cached results (file: packages/cli/preview-server/app/components/toolbar/SpamCheck.vue) (depends on T014)
- [ ] T024 Build compatibility analyzer — email client compatibility checking with Can I Email data (file: packages/cli/preview-server/app/components/toolbar/Compatibility.vue) (depends on T014)
- [ ] T025 Build toolbar container — tabbed panel integrating linter, spam, compatibility, and send features (file: packages/cli/preview-server/app/components/Toolbar.vue) (depends on T021, T022, T023, T024)

### Phase H: CLI Entry Point & Integration

- [ ] T026 Build CLI entry point — Commander.js setup registering all commands with options (file: packages/cli/src/index.ts) (depends on T007, T008, T009, T010, T011)
- [ ] T027 E2E integration test — verify dev server startup, template rendering, and hot reload cycle (file: packages/cli/src/__tests__/e2e.spec.ts) (depends on T026, T020, T025)
