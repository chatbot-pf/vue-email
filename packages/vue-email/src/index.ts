...
export { ECodeBlock } from './components/e-code-block/e-code-block'
export type { PrismLanguage } from './components/e-code-block/languages'
export type { Theme } from './components/e-code-block/themes'
export { ECodeInline } from './components/e-code-inline/e-code-inline'
...
export { EMarkdown } from './components/e-markdown/e-markdown'
// Advanced component types
export type { StylesType } from './components/e-markdown/styles'
