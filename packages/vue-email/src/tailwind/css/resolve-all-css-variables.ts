import type { CssNode, Declaration, List, ListItem, Raw, SelectorList, Value } from 'css-tree'
import {
...
const CSS_VARIABLE_PROPERTY_REGEX = /--\S+/
  ...
  walk(node, {
    ...
    enter(node: CssNode) {
      if (node.type === 'Declaration') {
        ...
        if (CSS_VARIABLE_PROPERTY_REGEX.test(declaration.property)) {
